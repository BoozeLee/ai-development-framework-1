...
def main():
    ...
    print(
        f"📦 Repositories: {install_results['successful']}/{install_results['total']} installed successfully"
    )
    print(
        f"🔗 AIOS Integration: {'✅ Complete' if integration_result['success'] else '❌ Failed'}"
    )
